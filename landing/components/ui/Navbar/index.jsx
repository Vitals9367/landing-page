    ...
    return (
        <header>
          ...
          <NavLink
            ...
            className="text-white text-bold text-md bg-gradient-to-r to-purple-500 from-blue-500 mb-5 hover:from-yellow-500 hover:via-red-500 hover:to-pink-500 hover:ring ring-transparent ring-offset-2 transition"
          >
            {config.cto.text}
          </NavLink>
