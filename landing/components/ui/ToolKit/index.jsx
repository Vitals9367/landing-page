    ...
    return (
        <SectionWrapper>
          ...
          <NavLink
            ...
            className="text-white text-bold text-lg bg-gradient-to-r to-purple-500 from-blue-500 hover:from-yellow-500 hover:via-red-500 hover:to-pink-500 hover:ring ring-transparent ring-offset-2 transition mb-5 mt-5"
          >
            $29 (one-time)
