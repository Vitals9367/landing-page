        ...
        <div className="items-center gap-x-12 lg:flex">
          ...
          <div className="max-w-xl mt-6 md:mt-0 lg:max-w-2xl">
            ...
            <NavLink
              ...
              className="inline-block mt-4 font-medium text-md text-white bg-gradient-to-r to-purple-500 from-blue-500 hover:bg-white active:bg-white hover:from-yellow-500 hover:via-red-500 hover:to-pink-500 hover: ring ring-transparent ring-offset-2 transition mb-2"
            >
              $29 (one-time)
            </NavLink>
            <br />
            <span className="text-md font-bold bg-clip-text text-transparent bg-gradient-to-r to-purple-500 from-blue-500 ml-1">
              SPECIAL 40% OFF{" "}
